...
```{r}
p2 +
  labs(title = "**_Rise_** and **_fall_** in the economy are cyclical") +
...
p2 +
  labs(title = "**Rise** and **_fall_** in the economy are cyclical",
       subtitle = "This is a finding from UTSA<sub>_TM_</sub>") +
  theme(plot.title = element_markdown(),
...
') +
  theme(plot.title = element_textbox_simple(lineheight = 1.2, fill = "lightsteelblue1",
                                            padding = margin(5.5, 5.5, 20, 5.5),
                                            margin = margin(0,0,0,10))) #pushed the box off the left
```
...
p2 +
  geom_textbox(data = text_dt, aes(label = mylabel),position = , fill = "lightsteelblue")
