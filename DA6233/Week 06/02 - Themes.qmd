...
```{r}
#| echo = TRUE
base + theme(plot.background = element_rect(fill = 'cyan'))
```
...
```{r}
#| echo = TRUE
base + theme(panel.grid.major = element_line(color = "violet", 
                                             linewidth = 2, 
                                             linetype = "solid")) +
...
```{r}
#| echo = TRUE
base + theme(axis.line = element_line(arrow = arrow(angle = 110, 
...
base + theme(axis.ticks = element_line(color = "red"),
             axis.ticks.length = unit(40, units = "pt"),
